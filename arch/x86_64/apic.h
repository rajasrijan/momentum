...
#define LVT_MASKED (1 << 16)
    ...
    struct local_apic_structure
    {
        ...
        uint8_t resv47[0x40];
        uint32_t tpr, resv3[0x3], apr, resv4[0x3], ppr, resv5[0x3], eoi, resv6[0x3], rrd, resv7[0x3], logical_dest, resv8[0x3], dest_format, resv9[0x3], svr,
            resv09[0x3];
        uint32_t isr0, resv10[0x3], isr1, resv11[0x3], isr2, resv12[0x3], isr3, resv13[0x3], isr4, resv14[0x3], isr5, resv15[0x3], isr6, resv16[0x3], isr7,
            resv17[0x3];
        uint32_t tmp0, resv18[0x3], tmp1, resv19[0x3], tmp2, resv20[0x3], tmp3, resv21[0x3], tmp4, resv22[0x3], tmp5, resv23[0x3], tmp6, resv24[0x3], tmp7,
            resv25[0x3];
        uint32_t irr0, resv26[0x3], irr1, resv27[0x3], irr2, resv28[0x3], irr3, resv29[0x3], irr4, resv30[0x3], irr5, resv31[0x3], irr6, resv32[0x3], irr7,
            resv33[0x3];
        uint32_t err_stat, resv34[0x3];
        uint8_t resv02[0x60];
        uint32_t lvt_cmcl, resv35[0x3], icr_lo, resv36[0x3], icr_hi, resv37[0x3], lvt_timer, resv38[0x3], lvt_thermal, resv39[0x3], lvt_perf, resv40[0x3],
            lvt_lint0, resv41[0x3], lvt_lint1, resv42[0x3], lvt_err, resv43[0x3], init_count, resv44[0x3], curr_count, resv45[0x3];
        uint8_t resv03[0x40];
